; Inno Setup script for Job Application Tracker v8 desktop companion.
...
#define MyAppName "Job Application Tracker v8"
...
OutputDir={#OutputDir}
OutputBaseFilename=JAT-v8-setup
Compression=lzma2
...
Name: "autostart"; Description: "Launch Job Application Tracker v8 automatically when Windows starts"; GroupDescription: "Startup:"; Flags: unchecked
...
[Registry]
; Register the jat8:// URL handler so the extension can launch the app.
Root: HKCU; Subkey: "Software\Classes\jat8"; ValueType: string; ValueName: ""; ValueData: "URL:Job Application Tracker v8 Protocol"; Flags: uninsdeletekey
Root: HKCU; Subkey: "Software\Classes\jat8"; ValueType: string; ValueName: "URL Protocol"; ValueData: ""
Root: HKCU; Subkey: "Software\Classes\jat8\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\{#MyAppExeName},0"
Root: HKCU; Subkey: "Software\Classes\jat8\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\{#MyAppExeName}"" ""%1"""
...
begin
  ...
  begin
    Log('JAT v8 install complete. Protocol jat8:// registered. Autostart=' + IntToStr(Ord(WizardIsTaskSelected('autostart'))));
  end;
end;
