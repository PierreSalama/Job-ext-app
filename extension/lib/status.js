// JAT v11 — status FSM.
// Mirrored in app/src/db.js (STATUS_ORDER / TERMINAL) — keep in lockstep.
// Forward-only when driven by the pipeline; manual edits can move anywhere;
// a fresh capture against a terminal job re-opens it (server-side rule).
